...
export function PositionForm() {
  const handleForm = (e: FormEvent<HTMLFormElement>) => {
    ...
    const formSchema = z.object({
      ...
      internalRef: z
        .number({
          required_error: "Internal Ref is required",
          invalid_type_error: "Internal Ref must be a number",
        })
        .gte(1, "Internal Ref must be equal or greater than 1"),
      opportunityInfo: z
        .string({ required_error: "Opportunity Information is required" })
        .trim()
        .min(2, "Opportunity Information must have at least 2 characters"),
      resume: z
        .any()
        .refine((file) => (file.size === 0 ? false : true), "File is required.")
        .refine(
          (file) => (file.size <= MAX_FILE_SIZE ? true : false),
        ...
        <div className="grid gap-7">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              type="number"
              name="internalRef"
              placeholder="Enter Internal Ref"
            />
          </div>
          ...
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              placeholder="Write Opportunity Information"
          ...
          <div className="grid gap-2">
            ...
            <Button
              ...
              variant={"outline"}
              className="w-fit"
              onClick={() => toast.info("I'aint sure what this should be :)")}
            >
              Select Team Members
            </Button>
          </div>
